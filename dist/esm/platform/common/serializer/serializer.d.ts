...
export declare function encodeJson(value: any, space?: string | number, circularRef?: any): string;
export declare function encodeJsonWithOptions(space?: string | number, circularRef?: any): (value: any) => string;
