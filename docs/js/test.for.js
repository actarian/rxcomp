...
CoreModule.meta = {
  ...
  _proto.onInit = function onInit() {
    ...
    {
      rxjs.interval(1000).pipe(operators.take(1000), operators.takeUntil(this.unsubscribe$)).subscribe(function () {
        _this2.flag = !_this2.flag;

        _this2.pushChanges();
      });
      rxjs.interval(500).pipe(operators.take(500), operators.takeUntil(this.unsubscribe$)).subscribe(function () {
        _this2.red = !_this2.red;
        _this2.notred = !_this2.notred;
...
var ExamplePipe = function (_Pipe) {
