...
CoreModule.meta = {
  ...
  return Browser;
}(Platform);var LocalStorageService = function () {
...
LocalStorageService.supported = false;var StoreService = function () {
...
StoreService.store$ = void 0;var AppComponent = function (_Component) {
