...
DatePipe.meta = {
  ...
  function RootComponent() {
    ...
    _this = _Component.call.apply(_Component, [this].concat(args)) || this;
    _this.html = "<b class=\"bold\">bold</b>";
    _this.valueUndefined = undefined;
    _this.valueDefined = 1;
    _this.ticks = -1;
    _this.items = [1, 2];
    _this.object = {
      a: 1,
...
var Root2Component = function (_Component2) {
  ...
  function Root2Component() {
    ...
    _this3.html = "<strong class=\"bold\">strong</strong>";
    _this3.valueUndefined = undefined;
    _this3.valueDefined = 2;
    _this3.ticks = -1;
    _this3.items = [2, 3];
    _this3.object = {
      a: 2,
...
var App2Module = function (_Module2) {
