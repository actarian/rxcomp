...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('test.parsing', ['rxjs', 'rxjs/operators'], factory) :
    ...
    ***************************************************************************** */
    ...
    var Root2Component = /** @class */ (function (_super) {
        __extends(Root2Component, _super);
        function Root2Component() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.html = "<strong class=\"bold\">strong</strong>";
            _this.valueUndefined = undefined;
            _this.valueDefined = 2;
            _this.ticks = -1;
            _this.items = [2, 3];
            _this.object = { a: 2, b: 3 };
            _this.date = new Date();
            return _this;
        }
        Root2Component.prototype.onInit = function () {
            var _this = this;
            // console.log('RootComponent.onInit');
            rxjs.interval(1000).pipe(operators.takeUntil(this.unsubscribe$)).subscribe(function (ticks) {
                _this.ticks = ticks;
    ...
    var App2Module = /** @class */ (function (_super) {
        __extends(App2Module, _super);
        function App2Module() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        return App2Module;
