...
typeof window !== 'undefined' && window.name === 'nodejs' || typeof navigator !== 'undefined' && navigator.userAgent.indexOf('Node.js') !== -1 || typeof navigator !== 'undefined' && navigator.userAgent.indexOf('jsdom') !== -1;
...
CoreModule.meta = {
  ...
  return Browser;
}(Platform);var CustomErrorInterceptor = function () {
  function CustomErrorInterceptor() {}

  var _proto = CustomErrorInterceptor.prototype;

  _proto.intercept = function intercept(error, next) {
    return next.handle(error).pipe(operators.map(function (error) {
      console.warn(error);
      return;
    }));
  };
...
var RootComponent = function (_Component) {
  ...
  function RootComponent() {
    ...
    _this.src = 'https://source.unsplash.com/random/400x300';
    return _this;
  }
  ...
  _proto2.onHandled = function onHandled(event) {
...
var SubComponent = function (_Component2) {
...
var HostDirective = function (_Directive) {
  _inheritsLoose(HostDirective, _Directive);
  ...
  function HostDirective() {
    ...
    _this4 = _Directive.call.apply(_Directive, [this].concat(args)) || this;
    _this4.style = void 0;
    return _this4;
  }
...
var HostedDirective = function (_Directive2) {
  _inheritsLoose(HostedDirective, _Directive2);
  ...
  function HostedDirective() {
    ...
    _this5 = _Directive2.call.apply(_Directive2, [this].concat(args)) || this;
    _this5.host = void 0;
    return _this5;
  }
  ...
  _proto5.onInit = function onInit() {
    ...
    rxjs.fromEvent(node, 'click').pipe(operators.takeUntil(this.unsubscribe$)).subscribe(function (event) {
      _this6.handled.next(event);

      _this6.unhandled.next(event);
    });
  };
...
var LabelComponent = function (_Component3) {
  ...
  function LabelComponent() {
    ...
    _this7 = _Component3.call.apply(_Component3, [this].concat(args)) || this;
    _this7.label = 0;
    return _this7;
  }
